...
from testscrapy.items import TestscrapyItem, DcontentItem  ##这是我定义的需要保存的字段，（导入dingdian项目中，items文件中的DingdianItem类）
from testscrapy.mysqlpipelines.sql import Sql
class Myspider(scrapy.Spider):
    ...
    def get_name(self, response):
        ...
        for td in tds:
            ...
            novelname = str(td.find('a')['title'])[:-2]
